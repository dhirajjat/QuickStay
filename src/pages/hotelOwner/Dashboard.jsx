  ...
  return (
    <div className='px-4 py-8 text-black'>
        <Title align="left" font ="outfit" title="Dashboard" 
         subtitle="Monitor your room listings , track bookings and analyze revenue-all in one palce. Stay updatrd with real-time insights to ensure smooth oprations." />
         ...
         <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lgmax-h-80 overflow-y-scroll'>
         <table className='w-full'>
            <thead className=' bg-gray-50'>
                <tr>
                    ...
                    <th className='py-3 px-4 text-gray-800 font-medium'>Pyment Status </th>
                </tr>
